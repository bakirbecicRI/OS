...
.LM23:
	movl	$6581362, 12(%rsp)
	.stabn	68,0,42,.LM24-.LFBB2
.LM24:
	call	cprintf
	.stabn	68,0,44,.LM25-.LFBB2
.LM25:
	movl	$.LC5, %edi
	movl	$3, %esi
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,46,.LM26-.LFBB2
.LM26:
	movl	$5, %edi
	call	test_backtrace
	.p2align 4,,10
...
.LM37:
	movl	$24, 8(%rsp)
	movl	$48, 12(%rsp)
	.stabn	68,0,77,.LM38-.LFBB3
.LM38:
	call	cprintf
	.stabn	68,0,78,.LM39-.LFBB3
.LM39:
	movq	%rbp, %rdi
	leaq	8(%rsp), %rsi
	call	vcprintf
	.stabn	68,0,79,.LM40-.LFBB3
.LM40:
	movl	$.LC7, %edi
	xorl	%eax, %eax
	call	cprintf
